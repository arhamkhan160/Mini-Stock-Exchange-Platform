...
| Document | Owner | Branch |
|---|---|---|
| [TEAM_A_INTEGRATION.md](TEAM_A_INTEGRATION.md) | Arham Ibrahim Khan | `main` |
| [TEAM_B_IDENTITY_AND_ASSETS.md](TEAM_B_IDENTITY_AND_ASSETS.md) | Arham Apon Utsho | `feat/team-b-identity` |
| [TEAM_C_TRADING_CORE.md](TEAM_C_TRADING_CORE.md) | Abidur Rahman Asif | `feat/team-c-trading` |
| [TEAM_D_MARKETDATA_AND_FRONTEND.md](TEAM_D_MARKETDATA_AND_FRONTEND.md) | Mustain Billah Taj | `feat/team-d-market-portfolio` |

Every document contains the same Section 1 contract: ports, money rules, JWT claims, gateway routes,
exact event payloads, Redis keys, internal REST endpoints, Docker/Alembic templates, frontend page
